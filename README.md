...
Для работы программы необходимо создать файл graph в котором граф будет записан в формате х--у, где х и у - две смежные вершины. Если вершина ни с чем не смежна, то записываем х--0.
